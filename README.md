...
Nella cartella [docs](docs) si trova la seguente documentazione tecnica :

- Il [contratto di servizio](docs/Caratteristiche_servizi) in formato [OpenAPI](docs/Caratteristiche_servizi) e [PDF](docs/Caratteristiche_servizi/docs).
